...
import { lessorDocuments } from './data';

const LessorDocuments: React.FC = () => {
  ...
  const docStats = [
    { label: 'Total documents', value: String(lessorDocuments.length), icon: DocumentTextIcon },
    { label: 'Diagnostics', value: String(lessorDocuments.filter(d => d.category === 'Diagnostic').length), icon: DocumentTextIcon },
    { label: 'Baux', value: String(lessorDocuments.filter(d => d.category === 'Bail').length), icon: DocumentTextIcon },
    { label: 'Titres de propriété', value: String(lessorDocuments.filter(d => d.category === 'Titre de propriété').length), icon: DocumentTextIcon },
  ];

  const filteredDocs = lessorDocuments.filter(d =>
...
export default LessorDocuments;
