    ...
    <div className="space-y-5">
      <div className="flex items-center gap-4 mb-2">
        ...
        <div>
          ...
          <button className="text-sm text-emerald-600 hover:text-emerald-700 font-medium mt-1 inline-block">Changer la photo</button>
        </div>
      </div>
    ...
    <div className="space-y-4">
      <label className="flex items-center gap-3 cursor-pointer p-3 border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Recevez nos actualités et offres exclusives</p>
        </div>
      </label>
      <label className="flex items-center gap-3 cursor-pointer p-3 border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Nouveaux biens correspondant à vos critères</p>
        </div>
      </label>
      <label className="flex items-center gap-3 cursor-pointer p-3 border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Alertes pour les rendez-vous</p>
        </div>
      </label>
    </div>
  );
    ...
    <div className="space-y-5">
      ...
      <label className="flex items-center gap-3 cursor-pointer p-3 border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Sécurisez votre compte avec une vérification en deux étapes</p>
        </div>
      </label>
